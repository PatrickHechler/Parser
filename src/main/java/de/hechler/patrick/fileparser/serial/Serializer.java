...
import static de.hechler.patrick.fileparser.serial.SerialConsts.NON_PRIMITIVE_FLOAT;
import static de.hechler.patrick.fileparser.serial.SerialConsts.NON_PRIMITIVE_INT;
import static de.hechler.patrick.fileparser.serial.SerialConsts.NON_PRIMITIVE_LONG;
import static de.hechler.patrick.fileparser.serial.SerialConsts.NON_PRIMITIVE_SHORT;
...
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_BOOLEAN;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_BYTE;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_CHAR;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_DOUBLE;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_FLOAT;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_INT;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_LONG;
import static de.hechler.patrick.fileparser.serial.SerialConsts.PRIMITIVE_SHORT;
import static de.hechler.patrick.fileparser.serial.SerialConsts.STRING;
...
public class Serializer {
	...
	private final boolean saveNonFinal;
	private final boolean saveSuperClassFiedls;
	
	public Serializer(boolean saveStatic, boolean saveNonStatic, boolean saveFinal, boolean saveNonFinal, boolean saveSuperClassFiedls) {
		this.saveStatic = saveStatic;
		this.saveNonStatic = saveNonStatic;
		this.saveFinal = saveFinal;
		this.saveNonFinal = saveNonFinal;
