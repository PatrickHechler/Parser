...
public class Parser {
	...
	/*
	 * public static final ParserTemplate EMPTY_TEMPLATE = new ParserTemplate(new
	 * String[0], new String[0], "", false, false, "", false, false, true, "", "",
	 * "", false, Collections.emptyList(), false, false, System.lineSeparator());
	 * public static final ParserTemplate MAIN_TEMPLATE = new ParserTemplate(new
	 * String[] {"int main() {", "\tasm volatile (" }, new String[] {"\t);",
	 * "\treturn 0;", "}" }, "\t\t\"", false, false, "\\n\"", false, false, false,
	 * ";", "//", "", true, Collections.emptyList(), false, false,
	 * System.lineSeparator()); public static final ParserTemplate ARDUINO_TEMPLATE
	 * = new ParserTemplate(new String[] {"void setup() {", "\tasm volatile (" },
	 * new String[] {"\t);", "}", "", "void loop() {}" }, "\t\t\"", false, false,
	 * "\\n\"", false, false, false, ";", "//", "", true, Collections.emptyList(),
	 * false, false, System.lineSeparator()); public static final ParserTemplate
	 * ARDUINO_TEMPLATE_WITH_EMPTY_ASM_LOOP = new ParserTemplate(new String[]
	 * {"void setup() {", "\tasm volatile (" }, new String[] {"\t);", "}", "",
	 * "void loop() {", "\tasm volatile (", "\t\t\"\\n\"", "\t);", "}" }, "\t\t\"",
	 * false, false, "\\n\"", false, false, false, ";", "//", "", true,
	 * Collections.emptyList(), false, false, System.lineSeparator()); public static
	 * final ParserTemplate ARDUINO_TEMPLATE_WITH_LOOP_REPLACE = new
	 * ParserTemplate(new String[] {"void setup() {", "\tasm volatile (" }, new
	 * String[] {"\t);", "}" }, "\t\t\"", false, false, "\\n\"", false, false,
	 * false, ";", "//", "", true, Arrays.asList(new
	 * Replace("^(\\s*)([lL][oO][oO][pP])\\s*\\:\\s*$",
	 * "$1\t\t\"$2\\:\\\\n\"\n\t);\n}\n\nvoid loop() {\n\tasm volatile(\n$1\t\t\"$2\\:\\\\n\""
	 ...
	 */
	public static final ParserTemplate EMPTY_TEMPLATE = new ParserTemplate(new String[0], new String[0], "", false,
			false, "", false, false, true, "", "", "", false, Collections.emptyList(), false, false,
			System.lineSeparator(), false);
	public static final ParserTemplate MAIN_TEMPLATE = new ParserTemplate(
			new String[] { "int main() {", "\tasm volatile (" }, new String[] { "\t);", "\treturn 0;", "}" }, "\t\t\"",
			false, false, "\\n\"", false, false, false, ";", "//", "", true, Collections.emptyList(), false, false,
			System.lineSeparator(), false);
	public static final ParserTemplate ARDUINO_TEMPLATE = new ParserTemplate(
			new String[] { "void setup() {", "\tasm volatile (" }, new String[] { "\t);", "}", "", "void loop() {}" },
			"\t\t\"", false, false, "\\n\"", false, false, false, ";", "//", "", true, Collections.emptyList(), false,
			false, System.lineSeparator(), false);
	public static final ParserTemplate ARDUINO_TEMPLATE_WITH_EMPTY_ASM_LOOP = new ParserTemplate(
			new String[] { "void setup() {", "\tasm volatile (" },
			new String[] { "\t);", "}", "", "void loop() {", "\tasm volatile (", "\t\t\"\\n\"", "\t);", "}" }, "\t\t\"",
			false, false, "\\n\"", false, false, false, ";", "//", "", true, Collections.emptyList(), false, false,
			System.lineSeparator(), false);
	public static final ParserTemplate ARDUINO_TEMPLATE_WITH_LOOP_REPLACE = new ParserTemplate(
			new String[] { "void setup() {", "\tasm volatile (" }, new String[] { "\t);", "}" }, "\t\t\"", false, false,
			"\\n\"", false, false, false, ";", "//", "", true,
			Arrays.asList(
					new Replace("^(\\s*)([lL][oO][oO][pP])\\s*\\:\\s*$",
							"$1\t\t\"$2\\:\\\\n\"\n\t);\n}\n\nvoid loop() {\n\tasm volatile(\n$1\t\t\"$2\\:\\\\n\""),
			...
			if (properties.startAfterWhite) {
				...
				int dif = 0;
				{
					...
					for (chars = line.toCharArray(); dif < chars.length; dif++) {
						if (chars[dif] > ' ')
							break;// ' ' is the higest whitespace all below is a command (like CR, LF, TAB, ...)
					}
